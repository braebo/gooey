	...
	<div class="info-wrapper">
		<div class="description em">
			<span bind:this={addEl}>
				The type of input generated by  <a href="/docs/create#adding"><code>add</code></a> is inferred from the second argument.
			</span>
		</div>

		{#if addEl}
			<Info target={addEl} side="left" tooltipText={['learn more', 'k thx']} --max-width="33rem">
				<div class="description">
