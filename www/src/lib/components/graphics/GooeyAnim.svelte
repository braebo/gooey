...
<div class="logo">
	<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" viewBox="0 0 500 190">
		<g id="slider-orbs" class="slider-orbs" clip-path="url(#clip0_454_35)">
			<ellipse
				id="orb2"
				cx="14"
				cy="13.2"
				fill="url(#gooey_anim_gradient_0)"
				class="orb2"
				rx="14"
				ry="13.2"
		...
		<defs>
			<linearGradient
				id="gooey_anim_gradient_0"
				x1="14"
				x2="14"
				y1="0"
				y2="26.4"
				class="gooey_anim_gradient_0"
			...
			<linearGradient
				id="gooey_anim_gradient_1"
				x1="8.9"
				x2="8.9"
				y1="0"
				y2="16.8"
				class="gooey_anim_gradient_1"
				gradientUnits="userSpaceOnUse"
			>
			...
			<linearGradient
				id="gooey_anim_gradient_2"
				x1="10.3"
				x2="10.3"
				y1="0"
				y2="19.4"
				class="gooey_anim_gradient_2"
				gradientUnits="userSpaceOnUse"
			>
			...
			<linearGradient
				id="gooey_anim_gradient_3"
				x1="8.9"
				x2="8.9"
				y1="0"
				y2="16.8"
				class="gooey_anim_gradient_3"
				gradientUnits="userSpaceOnUse"
			>
				<stop stop-color="#0094FF" />
				<stop offset="1" stop-color="#2B5C6B" />
			</linearGradient>
			<clipPath id="clip0_454_35" class="clip0_454">
				<path fill="#fff" d="M0 0h500v190H0z" />
			</clipPath>
			<filter
				id="gooey_anim_thumb_glow"
				width="101.3"
				height="123.1"
				x="253.3"
				y="69.9"
				class="gooey_anim_thumb_glow"
