 ...
 */
export type ColorString = HexString | HexAlphaString | HexStringShorthand | HexAlphaStringShorthand | RgbString | RgbaString | PercentageRgbString | PercentageRgbaString | RgbObject | RgbaObject | HslString | HslaString | HslObject | HslaObject | HsvObject | HsvaObject;
